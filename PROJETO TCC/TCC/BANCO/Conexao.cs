...
namespace TCC.CONTROLE
{
    class Conexao
    {
        ...
        public Conexao()
        {
            ...
            con4.ConnectionString = @"Data Source=LUKAS-PC;Initial Catalog=lfbd;Integrated Security=True;Connect Timeout=1;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
